...
<div class="body1">
 ...
 @include('layout.header')
   ...
   <div>
    ...
    <strong>W</strong><span>hat is Cleft Lip and Palate ?</span> 
      </h2>
      <h2 style="text-align: center;">
        <strong>C</strong><span>hallenging deformity which can be cured by due care.</span>
      </h2>
      <br>
 ...
 <button class="accordion"  style=" color: #575652; font-size: 17px;"> 
   ...
   <div class="panel" style="background-color:#d6d5d5; color: black;">
            <p>A large number of specialists make a team to take care of our children with cleft. They are:
              <ul>
                <li>
                  • <b>Plastic Surgeon or Maxillofacial Surgeon</b> to evaluate and perform necessary surgeries on the lip and/or palate</li>
                  <li>
                  • <b>Anaesthetist</b> to anaesthetise the baby for surgery. These are specialist anesthetists who are experienced in managing such children.</li><li>
                  • <b>Paediatrician</b> is an integral part of cleft team and takes care of nutrition, and infection of any kind. This child specialist needs to examine the child regularly before operation for any associated anomalies and fitness for anaesthesia.</li><li>
                  • <b>Otolaryngologist</b> (an ear, nose, and throat doctor) to evaluate hearing problems and consider treatment options for hearing problems.</li><li>
                  • <b>Oral & Maxillofacial or Plastic Surgeon</b> to reposition segments of the upper jaw when needed.</li><li>
                  • <b>Orthodontist</b> to straighten and reposition teeth.</li><li>
                  • <b>Pediatric Dentist</b> to perform routine dental care.</li><li>
                  • <b>Prosthodontist</b> to make artificial teeth and dental appliances to improve the appearance.</li><li>
                  • <b>Speech Language Pathologist</b> to assess speech and feeding problems.</li><li>
                  • <b>Speech Therapist</b> to train the child and parents to improve speech.</li><li>
                  • <b>Audiologist</b> to check and monitor hearing.</li><li>
                  • <b>Nurse Coordinator</b> to supervise the feeding, nutrition and growth of the child.</li><li>
                  • <b>Social Worker/Psychologist</b> to support the family and assess any social problems, teasing, adjustment in schools and colleges.</li><li>
                  • <b>Geneticist</b> to help parents and adult patients understand the chances of having more children with these conditions</li>

                
              </ul><br><p>To know more link to smile train centres www.smiletrainindia.org/treatment-centers.php as well as the website of the Indian society of Cleft Lip and palate and craniofacial anomalies.</p></p>    </div>
